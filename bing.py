...
class googleimagesdownload:
    ...
    def get_next_tab(self,s):
        ...
        if start_line == -1:  # If no links are found then give an error!
            ...
            url_item = "https://www.bing.com" + str(s[start_content + 6:end_content])
    ...
    def similar_images(self,similar_images):
        ...
        if cur_version >= version:  # If the Current Version of Python is 3.0 or above
            try:
                searchUrl = 'https://www.bing.com/searchbyimage?site=search&sa=X&image_url=' + similar_images
                headers = {}
                headers['User-Agent'] = "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36"
                ...
                newurl = "https://www.bing.com/search?tbs=sbi:" + urll + "&site=search&sa=X"
    ...
    def build_search_url(self,search_term,params,url,similar_images,specific_site,safe_search):
        ...
        if url:
            ...
            url = 'https://www.bing.com/search?q=' + keywordem + '&espv=2&biw=1366&bih=667&site=webhp&source=lnms&tbm=isch&sa=X&ei=XosDVaCXD8TasATItgE&ved=0CAcQ_AUoAg'
        elif specific_site:
            url = 'https://www.bing.com/search?q=' + quote(
    ...
    def download_image(self,image_url,image_format,main_directory,dir_name,count,print_urls,socket_timeout,prefix,print_size,no_numbering,no_download,save_source,img_src,silent_mode,thumbnail_only,format,ignore_urls):
        ...
        try:
            ...
            try:
                ...
                if no_numbering:
                    path = "/" + dir_name + "/" + prefix + image_name
                else:
