...
CMD_HELP.update({"lists": ["Lists",
    ...
    " - `.addlist <listname> <items>`: Creates a local list called 'listname' and adds items to it. "
    "Separate items with a newline. Local lists are only accessible from a specific chat.\n"
    " - `.addglist <listname> <items>`: Creates a global list called 'listname' and adds items to it. "
