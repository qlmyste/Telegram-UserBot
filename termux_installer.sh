pkg update
pkg install libxml2 libxslt libjpeg* libjpeg-turbo redis postgresql libwebp poppler ffmpeg git python resolv-conf 
pip3 install lottie cairosvg pytube3 pillow wakeonlan psutil ffmpeg moviepy spotify-token redis dnspython humanize pydrive wikipedia lxml search-engine-parser speedtest-cli telegraph telethon urbandict pytz requests googletrans gtts hachoir pybase64 aiohttp cowpy emoji gTTS-token gTTS gitpython google-api-python-client oauth2client google_images_download SQLAlchemy psycopg2-binary spectra google-cloud-speech google-cloud-texttospeech mutagen python-dotenv pydownload pylast pymongo Randomwords lyricsgenius convertapi pdf2image cairocffi
